...
import { Goals as GoalsUi, Goal as GoalUi } from './interactiveExpr/InteractiveGoals';
...
import { getInteractiveGoals, getInteractiveTermGoal, InteractiveDiagnostic, InteractiveGoal, InteractiveGoals } from './interactiveExpr/rpcInterface';
...
export function InfoDisplay(props0: InfoDisplayProps) {
    ...
    if (goals) copyGoalToComment = () => { } //void ec.copyToComment(getGoals(goal).join('\n\n')); }
