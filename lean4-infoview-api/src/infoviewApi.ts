import type { DocumentUri, InitializeResult, Location, ShowDocumentParams, TextDocumentPositionParams, TextEdit, WorkspaceEdit } from 'vscode-languageserver-protocol'
